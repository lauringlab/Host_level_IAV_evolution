...
# updated to get files from other directory.
path="../HIVE/"
...
# updated to get files from other directory.
path="../HIVE/"
variants_csv<-paste0(path,variants_csv)
variants<-read_rbind(variants_csv,n=6,cols = list(Id=col_character()))


#variants<-read_rbind(variants_csv,n=3,cols = list(Id=col_character()))
...
write.csv(x=diverse_variants,file="./data/processed/secondary/diverse_sites_isnv.csv")
