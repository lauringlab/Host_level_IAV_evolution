...
ks.test(min.qual$freq.var[min.qual$class_factor=="Nonsynonymous"],
        min.qual$freq.var[min.qual$class_factor=="Synonymous"])
...
min.count <-mutate(min.count,scratch = paste(chr,pos,var,chr,season,pcr_result,sep="."))
